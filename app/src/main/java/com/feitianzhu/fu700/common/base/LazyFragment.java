 ...
 * 故使用 {@link com.xmagicj.android.lazyfragment.LazyFragment#setForceLoad(boolean)}来让Fragment下次执行initData
 *
 * Created by Mumu
 * on 2015/11/2.
 * </pre>
...
public abstract class LazyFragment extends Fragment {
    ...
    /**
     * 设置fragment的Title直接调用 {@link com.xmagicj.android.lazyfragment.LazyFragment#setTitle(String)},若不显示该title 可以不做处理
     *
...
//            mLoadingDialog.closeFailedAnim();
//
////        }
//        mLoadingDialog.show();
//
